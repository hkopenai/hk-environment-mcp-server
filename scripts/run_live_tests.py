"""
Module for running live tests with pytest, enabling the RUN_LIVE_TESTS environment variable.
This script can run all live tests or a specific test if provided as an argument.
"""
